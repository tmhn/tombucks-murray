        ...
        <div>
            <div className="flex-1 min-w-0">
                ...
                <input
                    ...
                    className="block w-full px-4 py-3 text-medium text-gray-900 placeholder-gray-500 border-0 rounded-md"
                />
                <fieldset className="w-full mt-3">
                    <label htmlFor="coffee" className="sr-only">Language</label>
                    <div className="relative">
                        <select id="coffee" name="coffee" className="px-4 py-3 appearance-none block w-full bg-none bg-white border border-gray-300 rounded-md pl-3 pr-10 text-medium text-gray-900 sm:text-sm">
                ...
                <input
                    ...
                    className="mt-3 block w-full px-4 py-3 text-medium text-gray-900 placeholder-gray-500 border-0 rounded-md"
                />
            </div>
            <div className="mt-3">
                <button
